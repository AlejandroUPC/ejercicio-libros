package edu.upc.eetac.amartinez.lib.api.modelo;
...
import edu.upc.eetac.dsa.amartinez.libreria.api.BookResource;
import edu.upc.eetac.dsa.amartinez.libreria.api.LibreriaRootAPIResource;
import edu.upc.eetac.dsa.amartinez.libreria.api.MediaType;

public class LibROOTAPI {
	@InjectLinks({
